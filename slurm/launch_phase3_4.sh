...
echo "========================================"
echo "Phase 3 — Temporal split evaluation"
echo "========================================"
...
echo ""
echo "========================================"
echo "Phase 3 extra — Combined best on repo split"
echo "(validates the combination before temporal generalization claims)"
echo "========================================"

# Combined best on repo split — must beat both individual components
submit "repo_combined_best" "${BEST_NODES}"              ""  "${BEST_ABLATE}"    "repo_split"

echo ""
echo "========================================"
echo "Phase 4 — RGCN benchmark"
echo "========================================"
...
# 4-3: RGCN with best combined config — repo split
submit "rgcn_best_repo"     "${BEST_NODES}"    ""  "--model rgcn --num_bases 4 --dropout 0.3 --weight_decay 1e-4 ${BEST_ABLATE}"  "repo_split"

# 4-4: RGCN b4 with best config — temporal split (cross-architecture generalization test)
