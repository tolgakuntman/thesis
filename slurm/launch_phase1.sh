...
echo "========================================"
echo "Phase 1A — Node-type structural ablations"
echo "========================================"
...
# 1A-5: Minimal graph — only commit + file + function
submit "struct_minimal"    "hunk developer issue pull_request release_tag" ""  ""

echo ""
echo "========================================"
echo "Phase 1B — Edge-type structural ablations"
echo "========================================"
...
echo ""
echo "========================================"
echo "Phase 1C — Baselines (zeroing, for comparison with structural)"
echo "========================================"

# Full model (baseline for this phase — frozen protocol)
submit "phase1_full_baseline"  ""  ""  ""

echo ""
echo "========================================"
echo "Phase 1C — No-graph MLP null baseline"
echo "========================================"

# MLP baseline: no message passing at all — pure commit node features
