...
echo "========================================"
echo "Phase 2A â€” Code-side feature decomposition"
echo "(base: struct_no_hunk)"
echo "========================================"

# No function BERT embedding â€” tests if BERT is truly the critical code signal
submit "p2_no_fn_bert"        ""  ""  "--ablate_code_emb"

# No function code metrics â€” tests if numeric code features add anything beyond BERT
...
echo ""
echo "========================================"
echo "Phase 2C â€” SDLC component decomposition"
...
echo ""
echo "========================================"
echo "Phase 2D â€” Developer decomposition"
echo "(base: struct_no_hunk; full dev removal = struct_no_dev, already done)"
echo "========================================"

# Zero only developer node features â€” keep edge topology
