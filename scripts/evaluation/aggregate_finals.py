"""
scripts/evaluation/aggregate_finals.py
...
Usage:
    python scripts/evaluation/aggregate_finals.py
    python scripts/evaluation/aggregate_finals.py --checkpoints_dir /path/to/checkpoints
    python scripts/evaluation/aggregate_finals.py --prefix final_   # only 'final_*' runs
"""
